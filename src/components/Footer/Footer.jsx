    ...
    <footer>
      ...
      <div className="footer_dis">
        <p>
          ...
          CIN - IJ74999WB2012PTC184187 Chhotastock Technologies Private Limited.
        </p>
        <br />
        <p>
          ...
          Stocks/ETFs (Exchange Traded Funds) are subject to rnarket risks Read
          a' the related documents befo•e inæsting_ Irr•æstors should consider
          all risk factors and consult treir financial advisor before irøæstirg
        </p>
        <br />
        <p>
